...
さらにnishioの[[事前にやろうとしない運用哲学]]では、毎回のチェックすら省略する。間違いに気づいたタイミングで指摘→AIが一括修正で十分、という立場。これはPost-ingestレビューよりもさらに低コストな品質管理アプローチ。
...
- [[徒歩レビュー]] — Post-ingestレビューの具体的実装パターン。AIがフィルタ→人間は違和感のみ
